...
#define EDELETION		-19   // ERROR while deleting file
#define EOLDBLOCK		-20   // block with expired data
#define ENOBLOCK		-21	 // block beyond allocation range
#define ENODATA			-22	 // block has no data to read
